...
button.style ('background-color', color("#F9E7E7"));
...
button1.style('font-family', 'Times New Roman')
button1.style('font-size', '100px')
button1.style ('text-align', 'center');

button1.style ('background-color', color("#F9E7E7"));
...
button2.style('font-family', 'Times New Roman')
button2.style('font-size', '100px')
button2.style ('text-align', 'center');

button2.style ('background-color', color("#F9E7E7"));
...
//MAIN TEXT////
  ...
  main.style('font-family', 'Times New Roman')
...
function pop1() {
  ...
  pop1.style('font-family', 'Times New Roman')
  pop1.style('font-size', '33px')
  pop1.style('background-color', color("#932F6D"))
...
function pop2() {
  ...
  pop2.style('font-family', 'Times New Roman')
  pop2.style('font-size', '33px')
  pop2.style('background-color', color("#F9E7E7"))
...
function pop3() {
  ...
  pop3.style('font-family', 'Times New Roman')
  pop3.style('font-size', '33px')
  pop3.style('background-color', color("#932F6D"))
